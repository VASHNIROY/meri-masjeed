        ...
        <>
            ...
            <div className="masid-sub-container">
               ...
               <div className="salah-masid-left-container">
                    ...
                    <p className="app-para-text" style={{marginTop:'15px'}}>With My-Masjid your masjid is able to manage messages
                        ...
                        The timings and messages are available on both mobile phones and on
                         large screens in the masjid. My-masjid is free of cost.
                         <span><Link to='/MasidForm' style={{textDecoration:'none', color:'#60c2d3'}}>Register </Link></span> your masjid and get started today!</p>
                </div>
                <div className="salah-masid-right-container">
                    <img className="salah-image" src='https://my-masjid.com/wp-content/uploads/2021/01/image-14.png' alt='' />
                </div>
         ...
         <div className="masid-screen-display-container">
            ...
            <div className="masid-video-container">
                <ReactPlayer width="100%" url='https://www.youtube.com/watch?v=e_04ZrNroTo' controls />
            </div>
         </div>
         <div className="masid-card-contaner">
            <div className="masid-3-in-1-conatainer">
         ...
         <div className="masid-android-feature-container">
            ...
            <div className="masid-androd-container">
                <div className="masid-android-video">
                <ReactPlayer width="100%" height="300px" url='https://www.youtube.com/watch?v=hxOApe1P9dM' controls />
                </div>
                <div className="app-para-text">
         ...
         <div className="masid-smart-screen-container">
            <div className="masid-smart-tv">
                <img className="masid-smart-image" src='    https://my-masjid.com/wp-content/uploads/2020/12/my-masjid_android_tv-2-1.png' alt=''/>
            </div>
            <div className="masid-smart-checkmark">
            <p className="app-para-text" style={{display:"flex",alignItems:"center"}}><IoCheckmark className="masid-checkmark"/>Custom sound for adhan and iqamah times</p>
            <p className="app-para-text" style={{display:"flex",alignItems:"center"}}><IoCheckmark className="masid-checkmark"/>Full screen Adhan media playback for better visualization</p>
            <p className="app-para-text" style={{display:"flex",alignItems:"center"}}><IoCheckmark className="masid-checkmark"/>Option to launch My-Masjid application whenever devices restarts</p>
            <p className="app-para-text" style={{display:"flex",alignItems:"center"}}><IoCheckmark className="masid-checkmark"/>Option to disable screen time out so that app keeps on running all the time</p>
            <p className="app-para-text" style={{display:"flex",alignItems:"center"}}><IoCheckmark className="masid-checkmark"/>Switch between different display modes</p>
            <p className="app-para-text" style={{display:"flex",alignItems:"center"}}><IoCheckmark className="masid-checkmark"/>Use My-Masjid application as screen saver</p>
            <p className="app-para-text" style={{display:"flex",alignItems:"center"}}><IoCheckmark className="masid-checkmark"/>D-pad supported in-app navigation</p>
            <p className="app-para-text" style={{display:"flex",alignItems:"center"}}><IoCheckmark className="masid-checkmark"/>To download My Masjid for your Smart TV  <span> Click Here.</span></p>
            </div>
         </div>
         </>
