       ...
       <>
         <div className="privacy-policy-main-container">
           <div className="privacy-policy-heading-container">
             <h1 className="app-main-heading text-white">Privacy Policy</h1>
           </div>
           <div className="privacy-policy-text-container">
             ...
             <p className="privacy-text">
               Asaaya Technologies built the meri-Masjid (meri Masjid,
               meriMasjid) apps. This SERVICE is provided by Asaaya Technologies
             ...
             <p className="privacy-text">
               ...
               in our Terms and Conditions, which is accessible at Asaaya
               Technologies unless otherwise defined in this Privacy Policy.
             </p>
             <h1 className="privacy-text">Information Collection and Use</h1>
             <p className="privacy-text">
               For a better experience, while using our Service, we may require
               you to provide us with certain personally identifiable
               information, including but not limited to Name, Phone and Email.
             ...
             <h1 className="app-main-heading-2">Cookies</h1>
             <p className="privacy-text">
             ...
             <h1 className="app-main-heading-2">Service Providers</h1>
             <p className="privacy-text">
               We may employ third-party companies and individuals due to the
               following reasons:
             </p>
             <ul>
               <li className="privacy-list">To facilitate our Service</li>
             ...
             <h1 className="app-main-heading-2">Security </h1>
             <p className="privacy-text">
             ...
             <h1 className="app-main-heading-2">Links to Other Sites</h1>
             <p className="privacy-text">
             ...
             <h1 className="app-main-heading-2">Children’s Privacy </h1>
             <p className="privacy-text">
             ...
             <h1 className="app-main-heading-2">
