...
function SelectMasjid() {
    ...
    const selectCountry = async (country) => {
        ...
        const api = `http://localhost:3009/api/v1/getStates?country=${country}`
        const options = {
            method: "GET",
        }
    ...
    const selectState = async (state) => {
        ...
        // Fetch states based on the selected country
        const api = `http://localhost:3009/api/v1/getCities?country=${selectedCountry}&state=${state}`
        const options = {
            method: "GET",
        }
    ...
    const selectCity = async (city) => {
        ...
        // Fetch states based on the selected country
        const api = `http://localhost:3009/api/v1/getwebmasjeeds?country=${selectedCountry}&state=${selectedState}&city=${city}`
        const options = {
            method: "GET",
        }
